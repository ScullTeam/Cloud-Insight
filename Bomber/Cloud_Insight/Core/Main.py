    ...
    def ADD():
        ...
        page.add(
                ...
                Row([IconButton(icon='telegram', icon_size=48, tooltip='Канал', url='https://t.me/+z4L61XedSVllODAy', icon_color=color),
                    IconButton(icon='telegram', icon_size=48, tooltip='Канал 2', url='https://t.me/+utMmx5tGKSxlMTNi', icon_color=color),
                    IconButton(icon='attach_money', icon_size=48, tooltip='Нажми чтобы получить 1 TON', url='https://m.youtube.com/watch?v=dQw4w9WgXcQ', icon_color=color),
